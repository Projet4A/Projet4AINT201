...
df = pd.read_csv(r'C:\Users\piotr\ClientB_Reports.csv',converters={'SurveyDate':pd.to_datetime,'AnalysisDate':pd.to_datetime})
...
df.to_csv('ClientB_Reports_.csv',index=False)

data = pd.read_csv(r'C:\Users\piotr\ClientB_Vib_Data.csv', converters={'DateTime_x':pd.to_datetime})
...
data.to_csv('ClientB_Vib_Data_.csv',index=False)
